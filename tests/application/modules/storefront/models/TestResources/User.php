<?php
require_once APPLICATION_PATH . '/modules/storefront/models/resources/User/Interface.php';
require_once APPLICATION_PATH . '/modules/storefront/models/resources/User/Item/Interface.php';
...
class Storefront_Resource_User extends PHPUnit_Framework_TestCase implements Storefront_Resource_User_Interface
{
    ...
    public function saveData($info, $row = null) {
        if (null === $row) {
            $row = $this->createRow();
        }

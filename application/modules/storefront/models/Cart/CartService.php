 ...
 */
class Storefront_Model_Cart_CartService 
    ...
    implements SeekableIterator, Countable, ArrayAccess
{
   /**
    ...
    public function __construct($options = null,
                         Storefront_Model_Cart_ICartRepository $cartRepository = null) {
        parent::__construct($options);
        
        if ($cartRepository)
            $this->cartRepository = $cartRepository;
        else
            $this->cartRepository = new Storefront_Model_Cart_Session_CartRepository;
    }
     ...
     *
     * @param Storefront_Model_Catalog_IProductEntity $product
     * @param int $qty
    ...
    public function addItem(Storefront_Model_Catalog_IProductEntity $product, $qty)
    {
        ...
        $item = new Storefront_Model_Cart_CartEntity($product, $qty);   
     ...
     * 
     * @param int|Storefront_Model_Catalog_IProductEntity $product
     */

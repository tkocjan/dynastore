...
class MyApplication extends Zend_Application
{
    ...
    {
        if (ENABLE_INI_CACHE && is_array($options) && isset($options['config'])) {
            $this->_cacheConfig = true;
            
            // ini file is loaded in _loadConfig below, called by parent __construct
            ...
            if (isset($options['cacheOptions'])) {
                ...
                unset($options['cacheOptions']); //lazy copy by value
            }

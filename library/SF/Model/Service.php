 ...
 */
abstract class SF_Model_Service implements SF_Model_IService
{
    /**
    ...
    */
     ...
     * 
     * @param SF_Model_AbstractCache $cache
     */
    public function setCache(SF_Model_AbstractCache $cache)
    {
        $this->_cache = $cache;
    }

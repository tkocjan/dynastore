...
{
    /**
     * @var Storefront_Model_Catalog_ProductImageEntity
     */
    protected $_image;
     ...
     * productImage
     *
     * @param Storefront_Model_Catalog_ProductImageEntity $image
     * @param array $attribs Attributes for the img tag
     * @return Zend_View_Helper_ProductImage
     */
    public function productImage(Zstore\Domain\Catalog\ProductImageEntity $image = null, $attribs = false)
    {
        $this->_image = $image;

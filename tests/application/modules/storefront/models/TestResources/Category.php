<?php
require_once APPLICATION_PATH . '/modules/storefront/models/resources/Category/Interface.php';
require_once APPLICATION_PATH . '/modules/storefront/models/resources/Category/Item/Interface.php';

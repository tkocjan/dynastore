 ...
 */
abstract class SF_Model_AbstractCache
{
    /**
     ...
     * Constructor 
     * 
     * @param SF_Model_Service $model
     * @param array|Zend_Config $options 
     */
    public function __construct(SF_Model_Service $model, $options, $tagged = null)
    {
        $this->_model = $model;
